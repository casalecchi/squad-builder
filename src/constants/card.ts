...
export const statsCards: CardDetail[] = [
    ...
    {
        title: 'accurateCrossesPercentage',
        attributes: ['accurateCrossesPercentage'],
        unit: 'crosses',
        interval: { max: 100 },
        positionsNotAllowed: [],
        tab: CardTabEnum.percentage,
    ...
    {
        title: 'successfulDribblesPercentage',
        attributes: ['successfulDribblesPercentage'],
        unit: 'dribbles',
        interval: { max: 100 },
        positionsNotAllowed: [],
        tab: CardTabEnum.percentage,
    ...
    {
        title: 'groundDuelsWonPercentage',
        attributes: ['groundDuelsWonPercentage'],
        unit: 'duels',
        interval: { max: 100 },
        positionsNotAllowed: [],
        tab: CardTabEnum.percentage,
    ...
    {
        title: 'aerialDuelsWonPercentage',
        attributes: ['aerialDuelsWonPercentage'],
        unit: 'duels',
        interval: { max: 100 },
        positionsNotAllowed: [],
        tab: CardTabEnum.percentage,
    ...
    {
        title: 'tacklesWonPercentage',
        attributes: ['tacklesWonPercentage'],
        unit: 'tackleWon',
        interval: { max: 100 },
        positionsNotAllowed: [],
        tab: CardTabEnum.percentage,
